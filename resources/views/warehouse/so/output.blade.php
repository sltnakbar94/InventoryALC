...
<table cellspacing="0" border="0">
    ...
    @foreach ($data->details as $key=>$detail)
        <tr>
            ...
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><font color="#000000">{{@$detail->item->uom->name}}</font></td>
